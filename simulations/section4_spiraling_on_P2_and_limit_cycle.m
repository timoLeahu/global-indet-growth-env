...
% point. Even if some assumptions are not satisfied one still observe the 
...
hold on
plot3(Elv(1),Klv(1),Llv(1),'*','MarkerSize',4,'Color','b')% starting point
xlabel('E')
ylabel('K')
zlabel('L')
